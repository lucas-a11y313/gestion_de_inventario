...
@section('content')
    ...
    <div class="px-4 py-6">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-900 text-center mb-6">Solicitudes Eliminadas</h1>
            <nav class="breadcrumb mb-6">
                <div class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></div>
                <div class="breadcrumb-item"><a href="{{ route('solicitudes.index') }}">Solicitudes</a></div>
                <div class="breadcrumb-item active">Solicitudes Eliminadas</div>
            </nav>

            <div class="mb-6">
                <a href="{{ route('solicitudes.index') }}" class="bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-md font-medium transition-colors inline-flex items-center gap-2">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    Solicitudes eliminadas ({{ $solicitudes->count() }} registros)
                </div>
                <div class="card-body">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                @can('eliminar-solicitud')
                                                    <button onclick="window.solicitudModal.openRestoreModal({{ $solicitud->id }})" class="btn btn-info btn-sm">
            ...
            <div id="restoreModal" class="fixed inset-0 z-[60] overflow-y-auto" style="display: none;">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center">
                    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onclick="window.solicitudModal.closeRestoreModal()"></div>
                    ...
                    <div class="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="flex items-center">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">¿Estás seguro de que quieres restaurar esta solicitud?</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            ...
                            <button onclick="window.solicitudModal.closeRestoreModal()" class="btn btn-secondary">
                                Cerrar
                            </button>
                        </div>
                    </div>
...
@push('js')
    ...
    <script>
        ...
        window.solicitudModal = {
            openRestoreModal(solicitudId) {
                document.getElementById('restore-form').action = `/solicitudes/${solicitudId}/restaurar`;
