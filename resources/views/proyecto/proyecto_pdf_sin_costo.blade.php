  ...
  <table>
    ...
    <tfoot>
      <tr style="background-color: #f3f4f6;">
        <td colspan="2" class="text-right"><strong>Total de productos diferentes:</strong></td>
        <td colspan="2"><strong>{{ $proyecto->productos->count() }}</strong></td>
      </tr>
      <tr style="background-color: #f3f4f6;">
        <td colspan="2" class="text-right"><strong>Cantidad total de items:</strong></td>
        <td colspan="2"><strong>{{ $proyecto->productos->sum('pivot.cantidad') }}</strong></td>
      </tr>
    </tfoot>
  </table>
